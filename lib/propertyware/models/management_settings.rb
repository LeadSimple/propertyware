...
module Propertyware
  ...
  class ManagementSettings
    ...
    # Indicates the type of management fee. This field is deprecated and should not be used. Instead, use the new field 'managementFeesType'. 
    ...
    def hash
      [management_contract_end_date, management_contract_start_date, management_fee_type, management_fees, management_fees_type, management_flat_fee].hash
    end
