...
module Propertyware
  ...
  class OwnerDraw
    ...
    def hash
      [amount, comments, contact_id, created_by, created_date_time, date, destination_account_id, gl_account_id, id, last_modified_by, last_modified_date_time, lines, payment_type, portfolio_id, ref_no].hash
    end
