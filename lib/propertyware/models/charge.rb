...
module Propertyware
  class Charge
    ...
    # ID of the lease associated to auto charge
    ...
    def hash
      [amount, created_by, created_date_time, description, due_day, end_date, frequency, gl_account_id, id, last_modified_by, last_modified_date_time, last_post_date, lease_id, reference_number, start_date].hash
    end
