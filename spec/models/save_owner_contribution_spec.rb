...
# Unit tests for Propertyware::SaveOwnerContribution
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Propertyware::SaveOwnerContribution do
  let(:instance) { Propertyware::SaveOwnerContribution.new }

  describe 'test an instance of SaveOwnerContribution' do
    it 'should create an instance of SaveOwnerContribution' do
      expect(instance).to be_instance_of(Propertyware::SaveOwnerContribution)
    end
  end
