...
describe Propertyware::Configuration do
  let(:config) { Propertyware::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("https://api.propertyware.com/pw/api/rest/v1")
    # Propertyware.configure do |c|
    #   c.host = uri.host
  ...
  describe '#base_url' do
    it 'should have the default value' do
      ...
      # expect(config.base_url).to eq("https://api.propertyware.com/pw/api/rest/v1")
    end
